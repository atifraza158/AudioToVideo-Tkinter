...
def convert_audio_to_video(progress_var):
    ...
    if audio == '' or images == '':
        ...
        def _convert(progress_var):
            ...
            # Prepare audio and images for video conversion
            ...
            # Define output file path with proper file extension
    ...
    thread = Thread(target=_convert, args=(progress_var,))
    thread.start()
